...
export default defineConfig({
    ...
    build: {
        rollupOptions: {
            ...
            output: {
                manualChunks: function () { return 'everything.js'; }, // JavaScript 파일을 하나의 청크로 만듭니다.
            },
            // CSS 파일을 인라인으로 변환합니다.
            plugins: [
                {
                    ...
                    generateBundle: function (_, bundle) {
                        return __awaiter(this, void 0, void 0, function () {
                            var fileName, cssContent, cssChunk;
                            return __generator(this, function (_a) {
                                for (fileName in bundle) {
                                    if (bundle[fileName].type === 'chunk' && fileName.endsWith('.css')) {
                                        cssContent = readFileSync(bundle[fileName].fileName, 'utf-8');
